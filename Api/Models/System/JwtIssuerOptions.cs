...
namespace Api.Models.System
{
    public class JwtIssuerOptions
    {
		...
		/// <summary>
		/// 4.1.4.  "exp" (Expiration Time) Claim - The "exp" (expiration time) 
        /// claim identifies the expiration time on or after which the JWT MUST 
        /// NOT be accepted for processing.
		/// </summary>
		public DateTime Expiration => IssuedAt.Add(ValidFor);

		/// <summary>
		/// 4.1.5.  "nbf" (Not Before) Claim - The "nbf" (not before) claim 
		...
		/// <summary>
		/// 4.1.6.  "iat" (Issued At) Claim - The "iat" (issued at) claim 
